...
namespace DAL
{
    public class PersonaRepository
    {
        ...
        public void Guardar(Persona persona)
        {
            ...
            {
                command.CommandText = @"Insert Into Persona (Identificacion, Nombre,Apellido,Sexo,Edad,Departamento,Ciudad,ValorApoyo,Modalidad,Fecha,Valor) 
                                        values (@Identificacion,@Nombre,@Apellido,@Sexo,@Edad,@Departamento,@Ciudad,@ValorApoyo,@Modalidad,@Fecha,@Valor)";
